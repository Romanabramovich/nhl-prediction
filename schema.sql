...
CREATE TABLE team_stats (
    ...
    win_pct NUMERIC(10,6),
    home_games_played INTEGER,
    home_goal_diff INTEGER,
    home_goal_for INTEGER,
    home_goal_against INTEGER,
    home_losses INTEGER,
    ...
    road_goal_diff INTEGER,
    road_regulation_wins INTEGER,
    road_regulation_plus_ot_wins INTEGER,
    goals_for_pct NUMERIC(10,6),
    goals_against_pct NUMERIC(10,6),
    goal_diff INTEGER,
    goal_diff_pct NUMERIC(10,6),
    ...
    point_pct NUMERIC(10,6),
    regulation_win_pct NUMERIC(10,6),
    regulation_plus_ot_win_pct NUMERIC(10,6),
